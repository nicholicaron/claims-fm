...
| Pretrained, full fine-tune | 0.939 [0.918, 0.958] | 0.630 [0.522, 0.736] | 72.0% [56.0%, 82.0%] | 52.0% [41.0%, 63.0%] |
| Hybrid: XGBoost + frozen embeddings (M5.5) | 0.957 [0.938, 0.973] | 0.718 [0.615, 0.822] | 82.0% [64.0%, 92.0%] | 58.0% [46.0%, 69.0%] |

Operating point (pretrained transformer, top 100): precision 52.0%, recall 68.4%.
...
|---|---|---|---|---|
| 10% | 0.594 (±0.056) | 0.576 (±0.011) | — | 0.622 (±0.064) |
| 25% | 0.637 (±0.050) | 0.637 (±0.004) | — | 0.688 (±0.019) |
| 100% | 0.711 | 0.630 | — | 0.718 |

![money chart](figures/task_b_money_chart_17m18s.png)
