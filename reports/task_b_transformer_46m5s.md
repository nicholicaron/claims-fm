...
| Pretrained, full fine-tune | 0.938 [0.913, 0.962] | 0.704 [0.611, 0.796] | 80.0% [64.0%, 92.0%] | 54.0% [44.0%, 65.0%] |
...
|---|---|---|---|---|
| 10% | 0.594 (±0.056) | 0.494 (±0.007) | — | 0.622 (±0.064) |
| 25% | 0.637 (±0.050) | 0.682 (±0.005) | — | 0.688 (±0.019) |
| 100% | 0.711 | 0.704 | — | 0.718 |

![money chart](figures/task_b_money_chart_46m5s.png)
