"""Build the chunked Task B provider pack for hierarchical fine-tuning (Phase 2)."""

import argparse
import logging

from claimsfm.config import REPO_ROOT, load_config
from claimsfm.finetune.hier_data import build_task_b_pack_chunked
...
def main() -> None:
    ...
    meta = build_task_b_pack_chunked(
